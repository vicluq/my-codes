...
const email2 = "vickluq@gmailo.com";

console.log(email2.search('@') != -1); //search retorna o index do elemento procurado

console.log('Esse e-mail é válido?', email2.includes('@gmail.com') || email2.includes('@outlook.com') || email2.includes('@hotmail.com')); //retorna t ou f se incluir a substring
