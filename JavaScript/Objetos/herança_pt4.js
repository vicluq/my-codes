...
//Um exemplo: o método split, substring, charAt, etc são todos presentes no objeto String.prototype (pertencente à fun String) e por isso todas as strings podem acessar 
